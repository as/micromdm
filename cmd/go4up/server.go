...
func runServer(args []string) error {
	...
	var (
		flOutputDir = flagset.String(
			"output",
			filepath.Join(gopath(), "src", "github.com", "as", "micromdm", "example"),
			"path to output",
		)
	)
...
BUILD_VERSION = "\
	-X github.com/{{.Org}}/{{.Name}}/vendor/github.com/as/micromdm/go4/version.appName=${APP_NAME} \
	-X github.com/{{.Org}}/{{.Name}}/vendor/github.com/as/micromdm/go4/version.version=${VERSION} \
	-X github.com/{{.Org}}/{{.Name}}/vendor/github.com/as/micromdm/go4/version.branch=${BRANCH} \
	-X github.com/{{.Org}}/{{.Name}}/vendor/github.com/as/micromdm/go4/version.buildUser=${USER} \
	-X github.com/{{.Org}}/{{.Name}}/vendor/github.com/as/micromdm/go4/version.buildDate=${NOW} \
	-X github.com/{{.Org}}/{{.Name}}/vendor/github.com/as/micromdm/go4/version.revision=${REVISION} \
	-X github.com/{{.Org}}/{{.Name}}/vendor/github.com/as/micromdm/go4/version.goVersion=${GOVERSION}"
